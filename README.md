...
Model: aanandmodi/satquery-qwen3vl-bigearthnet-txt-lora
...
Important limitation: It is intended for RGB previews derived from optical imagery. Do not use raw SAR or 12-band Sentinel tensors with this adapter.

2. Multitemporal change detection
Model: deepang/adaptformer-LEVIR-CD
...
Model: BiliSakura/CROMA-transformers
...
Real Cartosat-2S optical + RISAT SAR preprocessing.
GeoTIFF metadata and geospatial coordinates.
Proper co-registration and reprojection.
A real optical-SAR specialist that accepts the required raw bands.
CDVQA/change-description evaluation.
VRSBench/RSVQA benchmark evaluation.
ISRO/SAC hidden-dataset testing.
